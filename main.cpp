...
#define HELP_MESSAGE    "HSE UNIVERSITY, 2021-2022, Kulikov Bogdan, second project program.\n"               \
                        "Task: 11, Function: 10\n"                                                          \
                        "\n"                                                                                \
...
int main(int argc, char* argv[]){
    ...
    if (random_size == -1){
        ...
        error_code = ct.randomFill(random_size, random_input_file);
